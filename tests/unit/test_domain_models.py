...
class TestDomainLogic:
    ...
    def test_service_health_status_mapping(self):
        ...
        healthy_status = ServiceStatus.HEALTHY if healthy_service.is_healthy else ServiceStatus.UNHEALTHY
        unhealthy_status = ServiceStatus.HEALTHY if unhealthy_service.is_healthy else ServiceStatus.UNHEALTHY
