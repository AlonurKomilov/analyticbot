...
class MockAuthService(BaseMockService):
    ...
    def create_user(
        ...
        if email in self._users:
            return {"success": False, "error": "User already exists", "user_id": None}
    ...
    def validate_token(self, token: str) -> dict[str, Any]:
        ...
        return {"valid": False, "error": "Invalid token", "user_id": None}
    ...
    def refresh_token(self, token: str) -> dict[str, Any]:
        ...
        return {"success": False, "error": "Invalid token", "new_token": None}
