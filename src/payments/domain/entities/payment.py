...
class Payment:
    ...
    def __init__(
        ...
        self._provider_payment_id: ProviderPaymentId | None = None
        ...
        self._refund_reason: str | None = None
        self._refunded_at: datetime | None = None
    ...
    def can_be_processed(self) -> bool:
        ...
        return self._status.value == PaymentStatusType.PENDING and not self._is_flagged
