...
class TestAnalyticsFusionServiceTrending:
    ...
    def baseline_posts(self):
        ...
        normal_views = [800, 950, 1100, 1050, 900, 1200, 850, 1300, 1150, 750,
                       1000, 1100, 950, 1250, 800, 1050, 900, 1150, 1000, 1100]
    ...
    def spike_posts(self):
        ...
        views_with_spikes = [
            800, 950, 1100, 5000,    # Spike 1: 5x normal
            900, 1200, 850, 1300, 1150, 750,
            8500,                     # Spike 2: 8.5x normal  
            1100, 950, 1250, 800, 1050,
    ...
    async def test_zscore_baseline_no_false_positives(self, fusion_service, mock_repos, baseline_posts):
