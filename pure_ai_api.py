...
class PureContentAnalyzer:
    ...
    def __init__(self):
        ...
        self.positive_words = {
            ...
            'revolutionizing', 'boosting', 'smart', 'powerful', 'effective'
        }
        ...
        self.negative_words = {
            ...
            'difficult', 'hard', 'struggle', 'pain', 'stress', 'worry', 'slow'
        }
    ...
    async def analyze_content(self, text: str, target_audience: str = "general") -> ContentAnalysisResult:
    ...
    def _suggest_hashtags(self, text: str, target_audience: str) -> List[str]:
        ...
        suggestions = self.hashtag_suggestions.get(target_audience, self.hashtag_suggestions['general']).copy()
...
async def get_api_stats():
    ...
    return {
        ...
        "supported_audiences": [
            "general", "tech", "business", "lifestyle", "social"
        ],
        "performance": {
...
async def not_found_handler(request, exc):
    return {
        ...
        "available_endpoints": [
            "/", "/health", "/analyze/content", "/score/realtime", "/demo/analyze", "/stats"
        ]
    }
