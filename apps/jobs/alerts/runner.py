...
class AlertDetector:
    ...
    def __init__(
        self,
        analytics_client: AnalyticsV2Client,
        alert_repository: AlertRepository
    ):
        self.analytics_client = analytics_client
        self.alert_repository = alert_repository
        
    async def detect_spike_alert(self, alert_config: Dict[str, Any]) -> Optional[Dict[str, Any]]:
    ...
    async def detect_quiet_alert(self, alert_config: Dict[str, Any]) -> Optional[Dict[str, Any]]:
    ...
    async def detect_growth_alert(self, alert_config: Dict[str, Any]) -> Optional[Dict[str, Any]]:
        ...
        try:
            ...
            if alert_result:
                ...
                if not recent_alert:
                    ...
                    logger.info(f"Sent {alert_type} alert to user {user_id} for channel {channel_id}")
                else:
        ...
        try:
            while self.running:
                ...
                if sleep_time > 0:
                    ...
                    logger.warning(f"Alert cycle took {cycle_duration:.1f}s, longer than interval {interval_seconds}s")
