...
def get_mock_churn_prediction(demo_type: str = "full_featured") -> dict:
    ...
    base_predictions = {
        ...
        "limited": {
            ...
            "key_factors": ["New user with growth potential"],
            "immediate_actions": ["Explore platform features"],
        },
    }
...
def get_mock_security_analysis(demo_type: str = "full_featured", content: str = None) -> dict:
    ...
    if content and any(
        keyword in content.lower() for keyword in ["hack", "malicious", "spam", "phishing"]
    ):
...
def get_mock_trending_analysis(demo_type: str = "full_featured") -> dict:
    ...
    base_trends = {
        ...
        "limited": {
            ...
            "recommendations": ["Explore trending topics", "Build audience engagement"],
        },
    }
