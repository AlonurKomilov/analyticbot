 ...
 */
export const categorizeError = (error: CustomError | null | undefined): ErrorType => {
...
export interface UserFriendlyError {
    ...
    message: string;
    action: string;
    originalError: CustomError | null | undefined;
}

/**
 * Gets user-friendly error information
 */
export const getUserFriendlyError = (error: CustomError | null | undefined, customMessage: string | null = null): UserFriendlyError => {
 ...
 */
export const CONTEXT_ERRORS: Record<string, Partial<Record<ErrorType, string>>> = {
    'add-channel': {
 ...
 */
export const getContextualError = (error: CustomError | null | undefined, context: string): UserFriendlyError => {
    const errorType = categorizeError(error);
 ...
 */
export const formatErrorForDisplay = (error: CustomError | null | undefined, context: string | null = null): DisplayError => {
    ...
    return {
        ...
        action: errorInfo.action,
        canRetry: retryableErrors.includes(errorInfo.type)
    };
};
