...
class StrategyGenerationService:
    ...
    async def generate_content_strategy_narrative(
        ...
        try:
            ...
            content_analysis = await self._analyze_current_performance(
                channel_id, timeframe
            )
    ...
    async def analyze_strategy_effectiveness(
        ...
        try:
            ...
            overall_score = await self._calculate_overall_effectiveness(
                effectiveness_analysis
            )
    ...
    async def _analyze_current_performance(self, channel_id: int, timeframe: int) -> dict:
        ...
        try:
            ...
            analysis["summary"] = {
                ...
                "strength": "consistency" if analysis["performance_consistency"] > 0.7 else "growth_potential",
    ...
    async def _identify_optimization_opportunities(
        ...
        try:
            ...
            opportunities.sort(key=lambda x: (
                x.get("impact_score", 0) + x.get("feasibility_score", 0)
            ), reverse=True)
