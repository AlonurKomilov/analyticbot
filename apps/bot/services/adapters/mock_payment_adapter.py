...
from apps.bot.models.payment import PaymentStatus, SubscriptionStatus, BillingCycle
...
class MockPaymentAdapter(PaymentGatewayAdapter):
    ...
    async def create_payment_method(
        ...
        payment_method = {
            ...
            "card": {
                ...
                "exp_year": 2025,
                "country": "US"
            } if method_data.get("type") == "card" else None,
    ...
    async def create_payment_intent(
        ...
        payment_intent = {
            ...
            } if status in ["succeeded", "processing"] else {"data": []}
        }
