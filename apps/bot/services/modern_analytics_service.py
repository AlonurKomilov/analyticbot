...
from apps.bot.services.adapters.analytics_adapter_factory import (
...
class ModernAnalyticsService:
    ...
    def __init__(self, provider: AnalyticsProvider | None = None, **kwargs):
        """
        ...
        logger.info(
            f"ModernAnalyticsService initialized with {self.adapter.get_adapter_name()} adapter"
        )

    async def get_channel_overview(self, channel_id: str, days: int = 30) -> dict[str, Any]:
        """
    ...
    async def get_post_performance(self, post_id: str, channel_id: str) -> dict[str, Any]:
        """
    ...
    async def get_engagement_analysis(self, channel_id: str, days: int = 30) -> dict[str, Any]:
        """
    ...
    async def get_growth_analysis(self, channel_id: str, days: int = 90) -> dict[str, Any]:
        """
    ...
    async def get_comprehensive_report(self, channel_id: str, days: int = 30) -> dict[str, Any]:
        """
            ...
            report = {
                ...
                "sections": {
                    ...
                    "audience": (
                        ...
                        else {"error": str(audience)}
                    ),
                    "engagement": (
                        engagement
                        if not isinstance(engagement, Exception)
                        else {"error": str(engagement)}
                    ),
                    "growth": (
                        growth if not isinstance(growth, Exception) else {"error": str(growth)}
                    ),
                },
                "executive_summary": self._generate_executive_summary(
                    overview, audience, engagement, growth
                ),
                "service_metadata": {
                    "generated_at": datetime.now().isoformat(),
                    "service": "ModernAnalyticsService",
    ...
    def _calculate_summary_metrics(self, analytics: dict[str, Any]) -> dict[str, Any]:
        ...
        return {
            ...
            "growth_rate": self._safe_percentage(
                overview.get("subscriber_change", 0),
                overview.get("total_subscribers", 1),
            ),
