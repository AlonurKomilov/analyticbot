...
def validate_helm_structure():
    ...
    try:
        ...
        if "dependencies" in chart_data:
            ...
            print(f"   ⚠️ dependencies - Not defined (optional)")
...
def check_helm_readiness():
    ...
    required_files = [
        "Chart.yaml", "values.yaml", "values-production.yaml", "values-staging.yaml"
    ]
    ...
    template_files = [
        ...
        "templates/configmap.yaml", "templates/secret.yaml"
    ]
