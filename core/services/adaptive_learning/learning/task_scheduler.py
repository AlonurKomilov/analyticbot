...
from ..protocols.learning_protocols import LearningTask, UpdateStatus
...
class TaskScheduler:
    ...
    async def get_queue_status(self) -> Dict[str, Any]:
        ...
        try:
            ...
            return {
                ...
                'queue_summary': {
                    priority.value: len([
                        s for s in self.task_queue if s.priority == priority
    ...
    def _remove_from_queue(self, task_id: str) -> None:
        ...
        try:
            ...
            self.task_queue = [
                schedule_info for schedule_info in self.task_queue
    ...
    async def _find_best_worker(self, task_id: str) -> Optional[str]:
