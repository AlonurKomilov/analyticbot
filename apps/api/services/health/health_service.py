...
class HealthService(HealthMonitoringService):
    ...
    def __init__(
        self,
        database_health: Optional[DatabaseHealthPort] = None,
        cache_health: Optional[CacheHealthPort] = None,
        external_service_health: Optional[ExternalServiceHealthPort] = None,
        system_resources: Optional[SystemResourcesPort] = None,
    ):
        ...
        if health_checks:
            try:
                results = await asyncio.gather(
                    *[check for _, check in health_checks],
