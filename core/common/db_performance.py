...
class DatabasePerformanceMonitor:
    ...
    @staticmethod
    @asynccontextmanager
    async def monitor_query(query_name: str, query: str | None = None):
        """
        ...
        try:
            ...
            # Record metrics
            try:
                from apps.api.middleware.performance_monitoring import (
                    performance_metrics,
                )
            ...
            if duration > 0.1:  # >100ms
                ...
                logger.info(f"Moderate query [{query_name}]: {duration:.3f}s")


# Convenience function
def monitor_query(query_name: str, query: str | None = None):
