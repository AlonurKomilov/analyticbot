...
type TypographyContext = 'title' | 'heading' | 'subheading' | 'paragraph';
...
export const typographyUtils = {
  ...
  applyHeadingScale: (level: HeadingLevel) => TYPOGRAPHY_SCALE[level] || TYPOGRAPHY_SCALE.h6,

  // Get semantic spacing for typography
  getTypographySpacing: (context: TypographyContext): number => {
    const spacingMap: Record<TypographyContext, number> = {
