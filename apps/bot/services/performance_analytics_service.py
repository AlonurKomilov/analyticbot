...
class PerformanceAnalyticsService:
    ...
    def _normalize_engagement_rate(self, engagement_rate: float) -> float:
        ...
        return min(100, max(0, (engagement_rate / self._thresholds['engagement_rate_max']) * 100))
    ...
    def analyze_performance_trends(self, historical_metrics: list[Dict[str, Any]]) -> Dict[str, Any]:
        """
