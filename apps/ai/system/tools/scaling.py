        ...
        return ToolDefinition(
            ...
            parameters_schema={
                ...
                "properties": {
                    ...
                    "direction": {"type": "string", "enum": ["up", "down"], "description": "Scale direction"},
                    "count": {"type": "integer", "default": 1, "description": "Number of instances to add/remove"},
        ...
        try:
            ...
            if new_instances == current_instances:
                return ToolResult(
                    ...
                    message=f"No scaling needed - already at limit",
                )
    ...
    def definition(self) -> ToolDefinition:
        return ToolDefinition(
            ...
            parameters_schema={
                "type": "object",
                "properties": {
                    "worker_name": {"type": "string", "description": "Worker to adjust"},
                    "new_interval_minutes": {"type": "number", "description": "New interval in minutes"},
