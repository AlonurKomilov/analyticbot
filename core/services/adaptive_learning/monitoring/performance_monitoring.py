...
from ..infrastructure.monitoring_infrastructure import (
...
class PerformanceMonitoringService:
    ...
    def __init__(
        ...
        config: Optional[MonitoringServiceConfig] = None,
    ...
    async def record_performance_metric(self, metric: PerformanceMetric) -> bool:
        ...
        try:
            ...
            logger.debug(f"📊 Recorded {metric.metric_type.value} for {metric.model_id}: {metric.value}")
            return True
