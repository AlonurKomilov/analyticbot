...
from ..entities.analytics_report import (
    AnalyticsReport,
    ReportId,
    ReportStatus,
    ReportType,
...
class IAnalyticsReportRepository(ABC):
    ...
    @abstractmethod
    async def get_by_id(self, report_id: ReportId) -> AnalyticsReport | None:
        """
    ...
    async def get_by_status(
        self, status: ReportStatus, user_id: UserId | None = None, limit: int = 100
    ) -> list[AnalyticsReport]:
        """
    ...
    async def get_reports_by_channel(
        self, channel_id: ChannelId, user_id: UserId, limit: int = 20
    ) -> list[AnalyticsReport]:
        """
    ...
    @abstractmethod
    async def get_report_by_share_token(self, share_token: str) -> AnalyticsReport | None:
        """
    ...
    async def cleanup_old_reports(
        self, older_than: datetime, status: ReportStatus | None = None
    ) -> int:
        """
    ...
    async def get_reports_for_regeneration(
        self, report_type: ReportType, user_id: UserId | None = None, limit: int = 10
    ) -> list[AnalyticsReport]:
        """
