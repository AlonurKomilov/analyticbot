...
Handles ad    analytics_service: AnalyticsOrchestratorService = Depends(get_analytics_fusion_service),inistrative system operations including statistics, monitoring, audit logs, and health checks.
