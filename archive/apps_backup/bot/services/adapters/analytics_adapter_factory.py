...
from apps.bot.services.adapters.telegram_analytics_adapter import TelegramAnalyticsAdapter, RateLimitConfig
...
class AnalyticsAdapterFactory:
    ...
    _current_adapter: Optional[AnalyticsAdapter] = None
