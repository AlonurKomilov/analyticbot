...
def find_and_fix_mock_imports():
    ...
    import_mappings = {
        ...
        r'from src\.api_service\.infrastructure\.testing\.services\.mock_analytics_service import MockAnalyticsService': 
        ...
        r'from src\.api_service\.infrastructure\.testing\.services\.mock_email_service import MockEmailService':
            'from src.mock_services.services.mock_email_service import MockEmailService',
        
        # Old generic service imports
        r'from src\.api_service\.infrastructure\.testing\.services import (.+)':
            r'from src.mock_services.services import \1',
        r'from src\.api_service\.application\.services\.__mocks__ import (.+)':
            r'from src.mock_services.services import \1',
        
        # Old test mock imports
        r'from tests\.mocks\.services\.mock_analytics_service import MockAnalyticsService':
            'from src.mock_services.services.mock_analytics_service import MockAnalyticsService',
        r'from tests\.mocks\.services\.mock_payment_service import MockPaymentService':
            'from src.mock_services.services.mock_payment_service import MockPaymentService',
        r'from tests\.mocks\.services\.mock_email_service import MockEmailService':
            'from src.mock_services.services.mock_email_service import MockEmailService',
        r'from tests\.mocks\.services import (.+)':
            r'from src.mock_services.services import \1',
        ...
        r'from \.\.testing\.services import (.+)':
            r'from src.mock_services.services import \1',
        r'from \.\.\.testing\.services import (.+)':
            r'from src.mock_services.services import \1',
        r'from \.\.infrastructure\.testing\.services import (.+)':
            r'from src.mock_services.services import \1',
    }
...
def main():
    ...
    print(f"   {'✅' if mock_services_ok else '❌'} Mock services: {'Working' if mock_services_ok else 'Failed'}")
