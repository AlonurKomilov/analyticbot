...
class Channel(AggregateRoot[ChannelId]):
    ...
    def __init__(
        ...
        user_id: UserId,
        title: ChannelTitle,
        username: ChannelUsername | None = None,
        channel_type: ChannelType = ChannelType.PUBLIC,
        status: ChannelStatus = ChannelStatus.ACTIVE,
        subscriber_count: int | None = None,
        description: str | None = None,
        total_posts: int = 0,
        total_views: ViewCount | None = None,
    ...
    def calculate_engagement_metrics(self) -> list[AnalyticsMetric]:
        ...
        if self.growth_rate is not None:
            growth = AnalyticsMetric(name="growth_rate", value=self.growth_rate, unit="%")
