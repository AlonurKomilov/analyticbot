...
Revision ID: 0024_add_channel_mtproto_settings
Revises: 0023_add_mtproto_audit_log
...
revision: str = '169d798b7035'
down_revision: Union[str, Sequence[str], None] = 'f7ffb0be449f'  # add_mtproto_audit_log
...
def upgrade() -> None:
    ...
    op.create_index('ix_channel_mtproto_user_enabled', 'channel_mtproto_settings', ['user_id', 'mtproto_enabled'])
