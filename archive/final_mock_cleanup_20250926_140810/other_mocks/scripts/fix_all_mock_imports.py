...
"""
    ...
    for file_path in mock_files:
        ...
        replacements = {
            "from apps.bot.services.adapters.mock_payment_adapter import MockPaymentAdapter": "# MockPaymentAdapter - using inline implementation",
            "from apps.bot.models.payment import BillingCycle": "from src.payments.domain.value_objects import BillingCycle",
            "from apps.bot.models.twa import InitialDataResponse": "from src.bot_service.domain.models.twa import InitialDataResponse",
        }
