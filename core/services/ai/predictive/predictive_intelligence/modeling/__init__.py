...
Usage:
    ...
    from core.services.ai.predictive.predictive_intelligence.modeling import PredictiveModelingService

    # Or use individual microservices
    from core.services.ai.predictive.predictive_intelligence.modeling import (
        PredictionGenerator,
