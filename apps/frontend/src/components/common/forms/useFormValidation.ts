...
export interface UseFormValidationReturn {
    ...
    handleSubmit: (onSubmit?: (values: FormValues) => void | Promise<void>) => Promise<boolean>;
...
export const useFormValidation = (
    ...
    const handleSubmit = useCallback(async (onSubmit?: (values: FormValues) => void | Promise<void>): Promise<boolean> => {
