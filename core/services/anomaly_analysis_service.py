...
class AnomalyAnalysisService:
        ...
        try:
            if metric == "views":
                ...
                if posts:
                    ...
                    if engagement_scores:
                        anomalies.extend(
                            self._statistical_anomaly_detection(
    ...
    async def _assess_anomaly_severity(self, anomaly_data: dict, historical_context: dict) -> dict:
    ...
    async def health_check(self) -> dict:
        ...
        return {
            ...
            "supported_metrics": ["views", "engagement", "growth", "followers"],
