...
def upgrade():
    ...
    op.create_table(
        ...
        sa.Column('service_key', sa.String(length=100), nullable=False, unique=True,
    ...
    op.create_table(
        ...
        sa.Column('old_limit', sa.Integer(),
                 comment='Previous limit value'),
        sa.Column('new_limit', sa.Integer(),
                 comment='New limit value'),
        sa.Column('old_period', sa.String(length=20),
                 comment='Previous period'),
        sa.Column('new_period', sa.String(length=20),
                 comment='New period'),
        sa.Column('old_enabled', sa.Boolean(),
                 comment='Previous enabled state'),
        ...
        sa.Column('changed_by_username', sa.String(length=200),
                 comment='Admin username'),
        sa.Column('changed_by_ip', sa.String(length=50),
    ...
    op.create_table(
        ...
        sa.Column('requests_blocked', sa.Integer(), nullable=False, server_default=sa.text('0'),
    ...
    op.create_index('idx_rate_limit_stats_window', 'rate_limit_stats', ['service_key', 'window_start', 'window_end'])
    op.create_index('idx_rate_limit_stats_ip_service', 'rate_limit_stats', ['ip_address', 'service_key'])
