...
class TestImportGraph:
    ...
    def test_core_has_no_forbidden_imports(self):
        ...
        assert len(forbidden_imports) == 0, f"Found forbidden imports in core: {forbidden_imports[:3]}"
    ...
    def test_infra_has_no_forbidden_imports(self):
        ...
        assert len(forbidden_imports) == 0, f"Found forbidden imports in infra: {forbidden_imports[:3]}"
...
class TestDomainService:
    ...
    def test_core_models_can_be_imported(self):
        ...
        try:
            from core.models import ScheduledPost, Delivery, PostStatus, DeliveryStatus
...
class TestDependencyInjection:
    ...
    def test_apps_containers_can_be_imported(self):
        ...
        assert len(successful_imports) > 0, f"No DI containers could be imported. Errors: {import_errors}"
