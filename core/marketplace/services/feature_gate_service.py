...
This service provides the primary interface for checking if users can use
specific marketplace features based on their subscription status.
"""
...
class FeatureGateService:
    ...
    async def can_use_advanced_analytics(self, user_id: int) -> bool:
        """Check if user can use advanced analytics service"""
        return await self.check_access(user_id, "bot_analytics_advanced")
