...
from src.shared_kernel.infrastructure.di import get_container, Settings as DISettings
...
async def get_analytics_fusion_service():
    ...
    try:
        ...
        from src.shared_kernel.domain.protocols import AnalyticsFusionServiceProtocol
        ...
        from src.api_service.di_analytics import get_analytics_fusion_service as di_get_service
...
async def get_predictive_analytics_engine():
    ...
    try:
        from src.shared_kernel.domain.di_container import container
        from src.shared_kernel.domain.protocols import AIServiceProtocol
...
async def get_redis_client():
    ...
    try:
        from src.shared_kernel.domain.di_container import container
        from src.shared_kernel.domain.protocols import RedisClientProtocol
...
async def get_current_user(
    ...
    from src.api_service.middleware.auth import get_current_user as auth_get_current_user
