...
from .nlg_service import InsightType, NarrativeStyle, NaturalLanguageGenerationService
...
class NLGIntegrationService:
    ...
    async def generate_multi_style_narratives(
        self, insights: dict, styles: list[NarrativeStyle] = None
    ) -> dict:
        """
            ...
            if summary_type == "performance":
                ...
                if recommendations:
                    ...
                    narrative = await self._nlg_service.generate_insight_narrative(
                        rec_data, InsightType.STRATEGIES, narrative_style
                    )
                    return narrative
                else:
                ...
                if patterns:
                    ...
                    return await self._nlg_service.generate_insight_narrative(
                        pattern_data, InsightType.TRENDS, narrative_style
                    )
                else:
