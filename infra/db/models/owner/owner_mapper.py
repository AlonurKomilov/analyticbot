...
from core.models.owner_domain import (
    AdminNotification,
    AdminRole,
    AdminSession,
    AdminUser,
...
# Import ORM models
from infra.db.models.owner.owner_orm import AdminAuditLog as AuditEntryORM
from infra.db.models.owner.owner_orm import AdminSession as AdminSessionORM
from infra.db.models.owner.owner_orm import AdminUser as AdminUserORM
from infra.db.models.owner.owner_orm import SystemConfiguration as SystemConfigORM
from infra.db.models.owner.owner_orm import SystemMetrics as AdminNotificationORM
from infra.db.models.owner.owner_orm import SystemUser as SystemComponentORM
...
class AdminDomainMapper:
    ...
    def orm_to_audit_entry(orm: AuditEntryORM) -> AuditEntry:
        ...
        return AuditEntry(
            ...
            ip_address=orm.ip_address,
            user_agent=orm.user_agent,
            metadata=orm.audit_metadata or {},
    ...
    def orm_to_admin_notification(orm: AdminNotificationORM) -> AdminNotification:
        ...
        return AdminNotification(
            ...
            is_read=orm.is_read,
            metadata=orm.notification_metadata or {},
            expires_at=orm.expires_at,
            created_at=orm.created_at,
            read_at=orm.read_at,
        )
