...
def find_and_fix_imports():
    ...
    import_mappings = {
        ...
        r"from src\.api_service\.application\.services\.__mocks__\.mock_(\w+)_service import Mock(\w+)Service": r"from src.mock_services.services import Mock\2Service",
        r"from src\.api_service\.infrastructure\.testing\.services\.mock_(\w+)_service import Mock(\w+)Service": r"from src.mock_services.services import Mock\2Service",
        r"from src\.bot_service\.application\.services\.adapters\.mock_(\w+)_adapter import Mock(\w+)Adapter": r"from src.mock_services.services import Mock\2Service",
        # Direct service imports
        r"from \.\.services\.mock_(\w+)_service import Mock(\w+)Service": r"from src.mock_services.services import Mock\2Service",
        r"from \.mock_(\w+)_service import Mock(\w+)Service": r"from src.mock_services.services import Mock\2Service",
        # Module-level imports
        r"from src\.api_service\.application\.services\.__mocks__ import mock_(\w+)_service": r"from src.mock_services.services import mock_\1_service",
        r"from src\.api_service\.infrastructure\.testing\.services import mock_(\w+)_service": r"from src.mock_services.services import mock_\1_service",
        # Specific service fixes
        r"from src\.api_service\.application\.services\.__mocks__\.mock_analytics_service import MockAnalyticsService": r"from src.mock_services.services import MockAnalyticsService",
        r"from src\.api_service\.infrastructure\.testing\.services\.mock_payment_service import MockPaymentService": r"from src.mock_services.services import MockPaymentService",
        r"from src\.bot_service\.application\.services\.adapters\.mock_analytics_adapter import MockAnalyticsAdapter": r"from src.mock_services.services import MockAnalyticsService",
        r"from src\.bot_service\.application\.services\.adapters\.mock_payment_adapter import MockPaymentAdapter": r"from src.mock_services.services import MockPaymentService",
    }
