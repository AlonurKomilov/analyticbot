 ...
 * 
 * Enables Single Sign-On across all 2Bot subdomains:
...
export const clearAuthData = (): void => {
  ...
  if (typeof localStorage !== 'undefined') {
    ...
    localStorage.removeItem('2bot_token');
    localStorage.removeItem('2bot_refresh_token');
    localStorage.removeItem('2bot_user');
  }
