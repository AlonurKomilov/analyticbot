 ...
 */
async function executeCheck(checkFn: (signal: AbortSignal) => Promise<HealthCheck>, timeoutMs: number = 10000): Promise<HealthCheck> {
 ...
 */
async function checkAPIBasicHealth(signal: AbortSignal): Promise<HealthCheck> {
 ...
 */
async function checkAPIDetailedHealth(signal: AbortSignal): Promise<HealthCheck> {
    const check = new HealthCheck(
 ...
 */
async function checkAuthEndpoint(signal: AbortSignal): Promise<HealthCheck> {
    const check = new HealthCheck(
 ...
 */
async function checkDashboardEndpoint(signal: AbortSignal): Promise<HealthCheck> {
    const check = new HealthCheck(
 ...
 */
async function checkAnalyticsEndpoints(signal: AbortSignal): Promise<HealthCheck> {
    const check = new HealthCheck(
        'Analytics Endpoints',
        CheckCategory.IMPORTANT,
 ...
 */
async function checkAPIPerformance(signal: AbortSignal): Promise<HealthCheck> {
    const check = new HealthCheck(
        'API Performance',
        CheckCategory.IMPORTANT,
 ...
 */
async function checkEnvironmentConfig(_signal: AbortSignal): Promise<HealthCheck> {
    const check = new HealthCheck(
 ...
 */
async function checkLocalStorage(_signal: AbortSignal): Promise<HealthCheck> {
    const check = new HealthCheck(
        'LocalStorage',
        CheckCategory.OPTIONAL,
