...
export const PerformanceLoadingFallback = memo(({
  ...
  lines = 3,
  variant = 'rectangular'
}: PerformanceLoadingFallbackProps): React.JSX.Element => {
...
export const PerformanceSuspense = memo(({
  ...
  onLoad,
  onError
}: PerformanceSuspenseProps): React.JSX.Element => {
 ...
 */
const LoadTracker = memo(({ children, onLoad }: LoadTrackerProps): React.JSX.Element => {
...
export const bundleAnalyzer = {
   ...
   */
  estimateComponentSize: (_componentName: string, metrics: BundleMetrics = {}): number => {
