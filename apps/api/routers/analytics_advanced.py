...
from apps.shared.models.alerts import AlertEvent as SharedAlertEvent
    ...
    try:
        ...
        if engagement_rate < 3:
            recommendations.append(
                "💬 Add more interactive content (polls, questions) to boost engagement"
            )
        ...
        if not recommendations:
            recommendations.append(
                "📊 Your analytics look stable. Keep monitoring for optimization opportunities"
            )
...
async def get_advanced_dashboard(
    ...
    try:
        ...
        trend_analysis = {
            ...
            "engagement_trend": (
                "improving" if combined_metrics["engagement_rate"] > 5 else "needs_attention"
            ),
