...
def find_all_mock_files():
    ...
    for root, dirs, files in os.walk("."):
        ...
        for file in files:
            ...
            if "src/mock_services/" in file_path or "archive/old_mock_services_backup" in file_path:
                continue
            ...
            if "mock" in file.lower() or "mock" in root.lower() or "__mocks__" in file_path:
                ...
                if file.endswith(".py") and any(
                    x in file for x in ["demo_", "complete_", "consolidate_", "analyze_"]
                ):
                    ...
                    or "src/api_service/infrastructure/testing" in file_path
        ...
        for dir_name in dirs:
            ...
            try:
                if (
                    ...
                    and "__pycache__" not in dir_path
                    and ".git" not in dir_path
                    and "archive" not in dir_path
                    and "src/mock_services" not in dir_path
                ):
                    os.rmdir(dir_path)
...
def generate_final_report(
    archive_dir, archived_count, removed_count, updated_files, mock_content_files
):
