...
class PredictionService:
    ...
    def __init__(self, cache_service=None, db_service=None):
        ...
        self.config = {
            'engagement_model': {
                ...
                'features': [
                    'hour_of_day', 'day_of_week', 'content_length',
                    'hashtag_count', 'media_count', 'sentiment_score',
                    'historical_avg', 'subscriber_count', 'channel_age'
                ]
            },
            'timing_model': {
                'name': 'optimal_timing',
            ...
            'churn_model': {
                ...
                'features': [
                    ...
                    'subscription_duration', 'plan_type', 'usage_frequency'
                ]
            }
        }
    ...
    async def _generate_synthetic_training_data(self, model_name: str) -> Tuple[np.ndarray, np.ndarray]:
        """Generate synthetic training data for initial model"""
        n_samples = 1000
    ...
    async def _extract_engagement_features(
        ...
        return [
            ...
            np.mean(content_metrics.engagement_history) if content_metrics.engagement_history else 100,  # historical_avg
        ...
        for factor, importance in top_factors:
            if factor == 'sentiment_score' and importance > 0.15:
                ...
                if content_metrics.hashtag_count < 3:
                    recommendations.append("📱 Add 3-5 relevant hashtags for better discoverability")
                ...
                if content_metrics.media_count == 0:
                    recommendations.append("🖼️ Add visual content (images/videos) to increase engagement")
