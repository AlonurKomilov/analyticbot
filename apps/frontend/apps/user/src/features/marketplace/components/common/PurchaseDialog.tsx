 ...
 * 
 * @module features/marketplace/components/common/PurchaseDialog
 */
...
import { getPrice, formatCredits, getSavingsDisplay } from '@/pages/marketplace/utils/priceFormatter';
      ...
      <DialogContent sx={{ pt: 2 }}>
        ...
        <Box>
          ...
          <Box sx={{ display: 'flex', justifyContent: 'space-between', mb: 1 }}>
            ...
            <Typography>{formatCredits(balance)} Credits</Typography>
          </Box>
          <Divider sx={{ my: 2 }} />
