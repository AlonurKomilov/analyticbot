...
class TelegramAnalyticsAdapter(AnalyticsAdapter):
    ...
    def __init__(self, bot_token: Optional[str] = None, rate_limit_config: Optional[RateLimitConfig] = None):
    ...
    async def _make_api_call(self, method: str, params: Optional[Dict[str, Any]] = None) -> Dict[str, Any]:
        """
