...
class ModelVersionType(Enum):
    """Model version types (renamed from ModelVersion to avoid conflict)"""
...
class ModelDeploymentStage(Enum):
    """Deployment stages for model updates (renamed from DeploymentStage to avoid conflict)"""
