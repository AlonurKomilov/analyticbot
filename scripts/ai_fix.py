...
def filter_allowed(patch: str) -> str:
    ALLOWED_DIRS = ['.']  # Allow all directories by default
...
def call_openai(prompt: str) -> str:
    SYSTEM_MSG = "You are a helpful code assistant."
...
def main():
    USER_INTRO = "Please analyze the following code and provide fixes."
