...
class TestUserOnboardingWorkflow:
    ...
    async def test_complete_user_registration_workflow(
        ...
        await mock_telegram_bot_workflow.send_message(
            ...
            reply_markup={"inline_keyboard": [
                [{"text": "Get Started", "callback_data": "onboarding_begin"}]
            ]}
        )
    ...
    async def test_user_onboarding_with_error_recovery(
        ...
        await mock_telegram_bot_workflow.send_message(
            chat_id=user_id,
            text="⚠️ Something went wrong. Retrying..."
        )
...
class TestChannelConnectionWorkflow:
    ...
    async def test_complete_channel_connection_workflow(
        ...
        update_workflow_state(workflow_id, {
            "stage": "channel_connection_start",
            "user_id": user_id
        })
        ...
        await mock_telegram_bot_workflow.send_message(
            ...
            reply_markup={"inline_keyboard": [
                [{"text": "📈 View Analytics", "callback_data": f"view_analytics_{channel_id}"}],
        ...
        # Workflow completion
        update_workflow_state(workflow_id, {
            "stage": "channel_connection_complete",
    ...
    async def test_complete_subscription_upgrade_workflow(
        ...
        await mock_telegram_bot_workflow.send_message(
            ...
            reply_markup={"inline_keyboard": [
                ...
                [{"text": "💼 Premium - $29.99/month", "callback_data": "plan_premium_monthly"}]
            ]}
        )
        ...
        await mock_telegram_bot_workflow.send_message(
            ...
            reply_markup={"inline_keyboard": [
                [{"text": "💰 Pay $29.99", "web_app": {"url": f"https://checkout.stripe.com/{payment_intent['client_secret']}"}}],
        ...
        payment_session = await mock_redis_workflow.hgetall(f"payment_session:{payment_intent['id']}")
...
class TestContentWorkflow:
    ...
    async def test_complete_content_scheduling_workflow(
        ...
        await mock_telegram_bot_workflow.send_message(
            ...
            reply_markup={"inline_keyboard": [
                [{"text": "❌ Cancel", "callback_data": "cancel_scheduling"}]
            ]}
        )
        ...
        update_workflow_state(workflow_id, {
            ...
            "content_text": content_message["text"]
        })
        ...
        await mock_redis_workflow.zadd(
            "scheduled_posts",
            {post_id: scheduled_time.timestamp()}
        )
...
👀 {metrics['top_performing_post']['views']:,} views"""
        ...
        await mock_telegram_bot_workflow.send_message(
            ...
            parse_mode="Markdown",
            reply_markup={"inline_keyboard": [
                [{"text": "📅 Different Period", "callback_data": f"analytics_period_{channel_id}"}],
                [{"text": "📧 Email Report", "callback_data": f"email_report_{channel_id}"}],
                [{"text": "📊 Detailed View", "callback_data": f"detailed_analytics_{channel_id}"}]
            ]}
        )
