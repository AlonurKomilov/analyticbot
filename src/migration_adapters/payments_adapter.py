"""
Migration Adapter for Payments
==============================
...
class PaymentsMigrationAdapter:
    """
    Adapter to bridge legacy apps/ and new src/payments/ implementations
    ...
    def __init__(self):
        ...
        logger.info(f"Payments Migration Adapter initialized - Legacy: {self._legacy_available}, Clean: {self._clean_available}")
...
def get_payments_service(service_name: str = "default") -> Any:
    """Get payments service using migration adapter"""
    adapter = PaymentsMigrationAdapter()
