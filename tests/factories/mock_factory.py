...
class MockFactory:
    ...
    def create_analytics_service(
        ...
        mock_service.update_analytics.return_value = {'success': True, 'updated_at': datetime.now().isoformat()}
    ...
    def create_bot_service(
        commands_data: Optional[List[Dict]] = None
    ) -> AsyncMock:
        """
        ...
        default_commands = [
            ...
            {'command': '/help', 'response': 'Available commands: /start, /analytics, /help'}
        ]
    ...
    def create_payment_service(
        ...
        mock_service.process_payment.return_value = {'success': True, 'payment_id': payment_result['payment_id']}
        mock_service.refund_payment.return_value = {'success': True, 'refund_id': 'ref_test_123'}
    ...
    def create_dashboard_service(
        ...
        default_dashboard = {
            ...
            'recent_activity': [
                ...
                {'action': 'user_joined', 'timestamp': (datetime.now() - timedelta(minutes=5)).isoformat()}
            ],
            'top_channels': [
