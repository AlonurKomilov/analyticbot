...
class PrometheusService:
    ...
    def _setup_metrics(self):
        ...
        self.users_total = Gauge(
            "users_total", "Total number of users", registry=self.registry
        )
    ...
    def record_database_query(self, operation: str, status: str, duration: float):
        ...
        self.database_query_duration_seconds.labels(operation=operation).observe(
            duration
        )
            ...
            async def async_wrapper(*args, **kwargs):
                ...
                try:
                    ...
                    if metric_name == "telegram_api":
                        ...
                        prometheus_service.record_database_query(
                            func.__name__, status, duration
                        )
                    elif metric_name == "celery_task":
                        prometheus_service.record_celery_task(
                            func.__name__, status, duration
                        )
