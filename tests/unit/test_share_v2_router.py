...
class TestShareV2Router:
    ...
    def test_share_request_models(self):
        ...
        try:
            from apps.api.routers.share_v2 import ShareRequest, ShareResponse

            # Test ShareRequest model structure
            share_request = ShareRequest(
                channel_id="@testchannel", report_type="overview", expires_in_hours=24
            )
    ...
    def test_http_exception_patterns(self):
        ...
        share_disabled_exc = HTTPException(
            status_code=503, detail="Share functionality is disabled"
        )
