        ...
        return ToolDefinition(
            ...
            parameters_schema={
                ...
                "properties": {
                    ...
                    "endpoint": {
                        "type": "string",
                        "description": "Health endpoint URL (optional)",
                    },
                    "timeout": {
                        "type": "integer",
                        "default": 5,
        ...
        return ToolDefinition(
            ...
            parameters_schema={
                ...
                "properties": {
                    "worker_name": {
                        "type": "string",
                        "description": "Worker name (optional, all if not specified)",
                    },
                    "metric_names": {
                        "type": "array",
                        "items": {"type": "string"},
                    ...
                    "include_system": {
                        "type": "boolean",
                        "default": True,
                        "description": "Include system metrics (CPU, memory)",
                    },
                },
            },
        )
        ...
        try:
            ...
            for worker in workers:
                ...
                if state:
                    ...
                    if metric_names:
                        worker_metrics = {
                            k: v for k, v in worker_metrics.items() if k in metric_names
                        }
        ...
        return ToolDefinition(
            ...
            parameters_schema={
                ...
                "properties": {
                    "worker_name": {
                        "type": "string",
                        "description": "Worker to analyze logs for",
                    },
