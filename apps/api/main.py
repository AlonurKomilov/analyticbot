...
from core.di_container import configure_services, container
...
from apps.api.routers.analytics_insights_router import (
    router as analytics_insights_router,
)
from apps.api.routers.analytics_predictive_router import (
    router as analytics_predictive_router,
)
from apps.api.routers.analytics_realtime_router import (
    router as analytics_realtime_router,
)
from apps.api.routers.demo_router import router as demo_router

app.include_router(
    analytics_core_router
)  # Core analytics functionality (dashboard, metrics, overview, trends, refresh)
...
)  # AI/ML predictions, forecasting, and advanced data analysis
