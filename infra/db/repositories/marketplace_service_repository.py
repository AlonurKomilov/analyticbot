...
Handles database operations for marketplace services system:
- Service catalog management
- User subscriptions (CRUD)
- Usage logging and quota tracking
"""
...
class MarketplaceServiceRepository:
    ...
    async def cancel_subscription(self, subscription_id: int, reason: str | None = None) -> dict:
