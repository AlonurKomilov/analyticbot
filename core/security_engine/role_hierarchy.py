...
class UserRoleInfo:
    ...
    role_level: int
    migration_profile: Optional[str] = None
...
class RoleHierarchyService:
    ...
    def migrate_legacy_role(self, old_role: str, role_type: str = "user") -> Tuple[str, List[str], Optional[str]]:
        """
    ...
    def get_available_roles(self, include_deprecated: bool = False) -> Dict[str, List[str]]:
        ...
        if include_deprecated:
            from .roles import UserRole, AdminRole
