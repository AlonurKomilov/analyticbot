...
class MockEmailService(BaseMockService, EmailServiceProtocol):
    ...
    async def send_template_email(self, to: str, template_name: str, variables: Dict[str, Any]) -> bool:
    ...
    async def send_bulk_email(self, recipients: List[str], subject: str, body: str) -> Dict[str, Any]:
        """Send bulk emails"""
