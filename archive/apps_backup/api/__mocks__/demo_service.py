...
class DemoDataService:
    ...
    def _create_demo_channels(self, count: int) -> List[Dict[str, Any]]:
        ...
        channel_templates = [
            {"name": "Tech Innovations", "username": "@tech_innovations", "category": "technology"},
            {"name": "Marketing Tips", "username": "@marketing_pro", "category": "business"},
            {"name": "Daily News", "username": "@daily_news_hub", "category": "news"},
            {"name": "Creative Studio", "username": "@creative_studio", "category": "design"},
            {"name": "Business Insights", "username": "@biz_insights", "category": "business"},
            {"name": "Health & Wellness", "username": "@health_wellness", "category": "health"},
            {"name": "Travel Adventures", "username": "@travel_adventures", "category": "travel"},
        ...
        for i in range(min(count, len(channel_templates))):
            ...
            channels.append({
                ...
                "is_active": True,
                "created_at": (self.base_date - timedelta(days=random.randint(30, 365))).isoformat(),
                "last_post_date": (self.base_date - timedelta(hours=random.randint(1, 72))).isoformat()
            })
    ...
    def _create_demo_scheduled_posts(self, count: int) -> List[Dict[str, Any]]:
        ...
        for i in range(count):
            posts.append({
                ...
                "scheduled_at": (self.base_date + timedelta(hours=random.randint(1, 168))).isoformat(),
                "status": "scheduled",
    ...
    def _generate_trending_posts(self, count: int) -> List[Dict[str, Any]]:
        ...
        for i in range(count):
            posts.append({
                ...
                "published_at": (self.base_date - timedelta(days=random.randint(1, 7))).isoformat()
            })
    ...
    def _generate_recent_posts(self, count: int) -> List[Dict[str, Any]]:
        ...
        for i in range(count):
            posts.append({
                ...
                "published_at": (self.base_date - timedelta(hours=random.randint(1, 48))).isoformat()
            })
