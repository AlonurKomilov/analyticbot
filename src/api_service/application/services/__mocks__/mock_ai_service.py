...
class MockAIService(AIServiceProtocol):
    ...
    def __init__(self):
        self.content_topics = [
            "Technology trends", "Social media marketing", "Business growth",
            "Digital transformation", "AI and automation", "Cryptocurrency",
            "Health and wellness", "Education", "Entertainment", "News"
        ]
    ...
    async def predict_engagement(self, content: str, posting_time: str) -> Dict[str, Any]:
        ...
        return {
            ...
            "optimal_posting_time": random.choice([
                "19:00", "20:00", "21:00", "08:00", "09:00"
            ]),
            "expected_metrics": {
