...
try:
    from src.api_service.presentation.routers.admin_users_router import *
    print("✅ Using clean architecture implementation from src.api_service.presentation.routers.admin_users_router")
    ...
    raise ImportError(f"Clean architecture module not available: src.api_service.presentation.routers.admin_users_router") from e
