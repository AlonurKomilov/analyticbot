...
def create_test_datasets():
    ...
    business_df.loc[np.random.choice(business_df.index, 20), "sales"] *= 3
...
async def test_module_4_1_data_processor():
    ...
    try:
        ...
        print("=" * 60)
        from apps.bot.analytics import AdvancedDataProcessor
...
async def test_module_4_2_predictive_engine():
    ...
    try:
        ...
        print("=" * 60)
        from apps.bot.analytics import PredictiveAnalyticsEngine
...
async def test_module_4_4_ai_insights():
    ...
    try:
        ...
        print("=" * 60)
        from apps.bot.analytics import AIInsightsGenerator
        ...
        alerts = await insights_gen.generate_automated_alerts(business_df, sensitivity="medium")
...
async def test_module_4_5_reporting():
    ...
    try:
        ...
        print("=" * 60)
        from apps.bot.analytics import AutomatedReportingSystem
