...
from ..protocols.learning_protocols import LearningProgress, LearningStrategy
from .progress_tracker import ProgressConfig, ProgressTracker
from .task_creator import TaskConfig, TaskCreator
from .task_scheduler import SchedulerConfig, TaskScheduler
...
class LearningTaskManager:
    ...
    def __init__(
        ...
        task_creator_config: TaskConfig | None = None,
    ...
    async def health_check(self) -> dict[str, Any]:
        ...
        try:
            ...
            # Overall health
            all_healthy = (
                creator_healthy.get("status") == "healthy"
                and scheduler_healthy.get("status") == "healthy"
                and "error" not in tracker_healthy
            )
