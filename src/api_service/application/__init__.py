...
try:
    print(
        "✅ Using clean architecture implementation from src.bot_service.infrastructure.database.__init__"
    )
    ...
    raise ImportError(
        "Clean architecture module not available: src.bot_service.infrastructure.database.__init__"
    ) from e
