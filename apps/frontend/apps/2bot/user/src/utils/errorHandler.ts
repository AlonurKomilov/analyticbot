...
class ErrorHandler {
     ...
     */
    static handleApiError(error: ApiError, endpoint: string, context: ErrorContext = {}): string {
     ...
     */
    static handleError(error: Error, context: ErrorContext = {}): string {
     ...
     */
    static handleUploadError(error: Error, file: FileInfo | null = null): string {
        ...
        return this.handleApiError(error as ApiError, '/upload', { fileName: file?.name });
    }
     ...
     */
    static formatErrorMessage(error: string | Error | any): string {
