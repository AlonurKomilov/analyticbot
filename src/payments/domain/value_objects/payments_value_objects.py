...
class PaymentProvider(ValueObject):
    ...
    def is_local_uzb(self) -> bool:
        ...
        return self.provider_type in [PaymentProviderType.PAYME, PaymentProviderType.CLICK]
    
    def supports_subscriptions(self) -> bool:
        """Check if provider supports subscriptions"""
        return self.provider_type in [PaymentProviderType.STRIPE, PaymentProviderType.PAYPAL]
...
class SubscriptionStatus(ValueObject):
    ...
    def is_active(self) -> bool:
        ...
        return self.status in [SubscriptionStatusType.ACTIVE, SubscriptionStatusType.TRIALING]
    ...
    def needs_payment(self) -> bool:
        ...
        return self.status in [SubscriptionStatusType.PAST_DUE, SubscriptionStatusType.UNPAID]
...
class SubscriptionStatus(ValueObject):
    ...
    def __init__(self, value: str):
        if value not in [self.ACTIVE, self.INACTIVE, self.PAUSED, self.CANCELED, self.EXPIRED]:
