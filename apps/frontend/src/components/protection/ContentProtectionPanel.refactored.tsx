...
import TheftDetection from './partials/TheftDetection';
import TextWatermark from './partials/TextWatermark';
import ImageWatermark from './partials/ImageWatermark';
            ...
            <Box>
                {tab === 0 && (
                    <TheftDetection
                        ...
                        onScan={() => cp.handleScanForTheft(channelId)}
                    />
                )}
