"""
Migration Adapter for Scheduling
================================
...
class SchedulingMigrationAdapter:
    """
    Adapter to bridge legacy apps/ and new src/scheduling/ implementations
    ...
    def __init__(self):
        ...
        logger.info(f"Scheduling Migration Adapter initialized - Legacy: {self._legacy_available}, Clean: {self._clean_available}")
...
def get_scheduling_service(service_name: str = "default") -> Any:
    """Get scheduling service using migration adapter"""
    adapter = SchedulingMigrationAdapter()
