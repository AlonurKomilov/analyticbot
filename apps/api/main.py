...
try:
    ...
    print("✅ Using clean architecture implementation from src.api_service.presentation.routers.main")
    ...
    raise ImportError(f"Clean architecture module not available: src.api_service.presentation.routers.main") from e
