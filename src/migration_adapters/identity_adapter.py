"""
Migration Adapter for Identity
==============================
...
class IdentityMigrationAdapter:
    """
    Adapter to bridge legacy apps/ and new src/identity/ implementations
    ...
    def __init__(self):
        ...
        logger.info(f"Identity Migration Adapter initialized - Legacy: {self._legacy_available}, Clean: {self._clean_available}")
...
def get_identity_service(service_name: str = "default") -> Any:
    """Get identity service using migration adapter"""
    adapter = IdentityMigrationAdapter()
