"""
Framework-agnostic task utilities for AnalyticBot.

This module provides task retry logic and utilities that can be used
across MTProto, Bot, and Celery task modules without framework-specific
dependencies.
"""
