...
from src.mtproto_service.collectors.updates import UpdatesCollector
from src.mtproto_service.config import MTProtoSettings
from src.mtproto_service.di import create_tg_client, get_repositories
...
class UpdatesPoller:
    ...
    def __init__(self):
        self.collector: UpdatesCollector | None = None
        self.running = False
