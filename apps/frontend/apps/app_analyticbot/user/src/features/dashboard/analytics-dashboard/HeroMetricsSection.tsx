...
const HeroMetricsSection: React.FC<HeroMetricsSectionProps> = ({
    ...
    // If showing placeholder (no channel selected), show message
    if (showPlaceholder) {
        return null; // Hero section hidden when no channel selected
    }
    ...
    const metrics: Metric[] = [
        {
            label: 'Total Views',
            value: totalViews,
            trend: totalViews !== '—' ? growthRate : undefined,
        ...
        },
        {
            label: 'Total Posts',
            value: totalPosts,
            trend: totalPosts !== '—' ? 5.2 : undefined,
        ...
        },
        {
            ...
            trend: engagementRate !== '—' ? 8.1 : undefined,
            icon: <EngagementIcon sx={{ fontSize: 40 }} />,
            color: theme.palette.warning.main
        },
        {
            label: 'Performance',
            value: totalViews !== '—' ? '94/100' : '—',
            trend: totalViews !== '—' ? 3.5 : undefined,
