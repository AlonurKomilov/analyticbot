...
async def test_encryption():
    ...
    print(f"\n{'='*60}")
    print(f"Testing API Key Encryption")
    print(f"{'='*60}")
...
async def test_registry():
    ...
    print(f"\n{'='*60}")
    print(f"Testing Provider Registry")
    print(f"{'='*60}")
...
async def main():
    """Run all tests."""
    print(f"\n{'#'*60}")
    print(f"# Multi-Provider AI System Test Suite")
    print(f"{'#'*60}")
    ...
    print(f"\n\n{'='*60}")
    print(f"Provider Tests (requires API keys)")
    print(f"{'='*60}")
