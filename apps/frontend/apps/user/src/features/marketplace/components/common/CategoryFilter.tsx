 ...
 * 
 * @module features/marketplace/components/common/CategoryFilter
 */
...
import type { MarketplaceCategory } from '@/pages/marketplace/types';
import { CATEGORY_CONFIGS } from '@/pages/marketplace/utils/categoryConfig';
