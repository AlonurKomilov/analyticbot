...
class PaymentSystemTester:
    ...
    async def setup(self):
        ...
        self.stripe_adapter = StripeAdapter(
            api_key=self.settings.STRIPE_SECRET_KEY.get_secret_value() if self.settings.STRIPE_SECRET_KEY else "test_key",
            webhook_secret=self.settings.STRIPE_WEBHOOK_SECRET.get_secret_value() if self.settings.STRIPE_WEBHOOK_SECRET else "test_secret"
        )
    ...
    async def test_api_models(self):
        ...
        try:
            ...
            self.log_test_result(
                ...
                subscription_data.plan_id == 1 and subscription_data.billing_cycle == BillingCycle.MONTHLY,
    ...
    async def test_frontend_integration_readiness(self):
        ...
        try:
            ...
            if os.path.exists(package_json_path):
                with open(package_json_path, 'r') as f:
                    ...
                    stripe_deps_configured = (
                        '@stripe/react-stripe-js' in dependencies and
            ...
            self.log_test_result(
                ...
                stripe_deps_configured,
                "Stripe React dependencies configured" if stripe_deps_configured else "Stripe dependencies missing"
            )
    ...
    def print_summary(self):
        ...
        backend_tests = [r for r in self.test_results if "Stripe" in r["test"] or "Payment Service" in r["test"] or "Models" in r["test"]]
        ...
        frontend_tests = [r for r in self.test_results if "Frontend" in r["test"] or "Component" in r["test"]]
