...
from src.api_service.di_analytics import get_cache
from src.api_service.schemas.analytics import SeriesResponse
...
async def get_live_monitoring_data(
    ...
    try:
        ...
        performance_alerts = generate_performance_alerts(recent_overview, recent_growth, recent_reach)
...
def calculate_activity_level(overview_data, growth_data, reach_data) -> str:
    ...
    try:
        ...
        elif engagement > 2: return "medium"
        else: return "low"
    except:
        return "unknown"
...
def calculate_trend_indicators(overview_data, growth_data, reach_data) -> Dict[str, str]:
    ...
    try:
        ...
        return {
            ...
            "engagement_trend": "📈" if engagement_rate > 2 else "📉" if engagement_rate < 1 else "➡️"
        }
    except:
