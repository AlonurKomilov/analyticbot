...
Usage:
    ...
    from core.services.ai.adaptive.adaptive_learning.learning import IncrementalLearningEngine

    # Or use individual microservices
    from core.services.ai.adaptive.adaptive_learning.learning import (
        LearningStrategy,
        MemoryManager,
        ContextManager,
        ModelOperator,
