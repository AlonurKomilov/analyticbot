...
class User(AggregateRoot):
    ...
    def create_new_user(
        ...
        user = cls(
            ...
            status=UserStatus.PENDING_VERIFICATION if auth_provider == AuthProvider.LOCAL else UserStatus.ACTIVE
        )
    ...
    def set_password(self, password: str) -> None:
        ...
        self.add_domain_event(UserPasswordChanged(
            ...
            changed_at=self.last_password_change
        ))
    ...
    def update_profile(self, full_name: Optional[str] = None, timezone: Optional[str] = None, 
                      language: Optional[str] = None, avatar_url: Optional[str] = None) -> None:
    ...
    def can_access_analytics(self) -> bool:
        ...
        return self.role in [UserRole.ADMIN, UserRole.MODERATOR, UserRole.ANALYST, UserRole.USER]
