...
async def test_direct_ml():
    ...
    try:
        ...
        y_train = (
            X_train[:, 0] * 50 + X_train[:, 1] * 30 + np.random.randn(100) * 10 + 100
        )
    ...
    try:
        ...
        print("   📊 Model Accuracy: Training completed")
    ...
    print("   • Content analysis with sentiment scoring")
    print("   • ML-based engagement prediction")
    print("   • Churn risk assessment")
    print("   • Real-time content optimization")
    print("   • Hashtag and readability analysis")
