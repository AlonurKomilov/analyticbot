...
class IntelligenceRequest:
    ...
    intelligence_context: Optional[List[str]] = None  # 'temporal', 'environmental', 'competitive', 'behavioral'
...
class IntelligenceResult:
    ...
    prediction_narrative: Optional[Dict[str, str]] = None
    enhanced_confidence: float = 0.0
    temporal_intelligence: Optional[Dict[str, Any]] = None
    cross_channel_intelligence: Optional[Dict[str, Any]] = None
