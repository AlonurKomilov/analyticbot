...
class TestExportsV2RouterSimple:
    ...
    def test_http_exception_handling(self):
        ...
        export_disabled_exc = HTTPException(
            status_code=403, detail="Export functionality is disabled"
        )
...
class TestExportsV2Router:
    ...
    def test_export_status_model_optional_fields(self):
        ...
        with patch.dict(
            ...
            status = ExportStatus(success=False, message="Error message")
    ...
    def test_factory_functions(self):
        ...
        with patch.dict(
            ...
            from apps.api.routers.exports_v2 import (
                get_analytics_client,
                get_csv_exporter,
            )
    ...
    async def test_export_csv_endpoint_simulation(self):
        ...
        with patch.dict(
            "sys.modules",
            {
                ...
                "apps.bot.clients.analytics_v2_client": Mock(
                    AnalyticsV2Client=mock_analytics_client
                ),
            },
        ):
            ...
            with patch("apps.api.routers.exports_v2.Settings") as mock_settings:
                ...
                mock_analytics_client_instance.get_overview.assert_called_once_with(
                    "@testchannel", 30
                )
...
class TestExportsV2RouterIntegration:
    ...
    def test_endpoint_registration(self):
        ...
        with patch.dict(
            ...
            assert (
                len(chart_routes) >= 0
            )  # Should have chart export routes (might be 0 if not available)
    ...
    async def test_dependency_injection_pattern(self):
        ...
        with patch.dict(
            ...
            from apps.api.routers.exports_v2 import get_analytics_client
    ...
    def test_response_model_validation(self):
        ...
        with patch.dict(
            ...
            valid_status = ExportStatus(
                success=True, message="Success", filename="test.csv", size_bytes=1024
            )
            assert valid_status.success is True

            # Test model with optional fields None
            minimal_status = ExportStatus(success=False, message="Error")
