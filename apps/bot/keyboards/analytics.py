...
class AnalyticsKeyboards:
    ...
    @staticmethod
    def channels_keyboard(channels: List[Tuple[str, str]], page: int = 0, per_page: int = 5) -> InlineKeyboardMarkup:
        ...
        pagination_row.append(
            InlineKeyboardButton(text=f"{page+1}/{total_pages}", callback_data="analytics:page_info")
        )
        ...
        # Add back button
        keyboard.append([InlineKeyboardButton(text="◀️ Back to Menu", callback_data="analytics:main")])
    ...
    def analytics_tabs_keyboard(channel_id: str, period: int) -> InlineKeyboardMarkup:
        ...
        # Navigation
        keyboard.append([
            InlineKeyboardButton(text="🔄 Refresh", callback_data=f"analytics:refresh:{channel_id}:{period}"),
            InlineKeyboardButton(text="⏰ Change Period", callback_data=f"analytics:period:{channel_id}"),
        ])
    ...
    def export_options_keyboard(channel_id: str, period: int) -> InlineKeyboardMarkup:
        ...
        keyboard.append([
            InlineKeyboardButton(text="◀️ Back to Analytics", callback_data=f"analytics:overview:{channel_id}:{period}")
        ])
    ...
    def alerts_main_keyboard(channel_id: str) -> InlineKeyboardMarkup:
        ...
        keyboard.append([
            InlineKeyboardButton(text="◀️ Back to Analytics", callback_data=f"analytics:overview:{channel_id}:30")
        ])
    ...
    def alert_types_keyboard(channel_id: str) -> InlineKeyboardMarkup:
        ...
        keyboard.append([
            InlineKeyboardButton(text="◀️ Back to Alerts", callback_data=f"alerts:main:{channel_id}")
        ])
    ...
    def alert_management_keyboard(alert_id: int, channel_id: str) -> InlineKeyboardMarkup:
        ...
        keyboard.append([
            InlineKeyboardButton(text="◀️ Back to Alerts", callback_data=f"alerts:list:{channel_id}")
        ])
    ...
    def top_posts_keyboard(channel_id: str, period: int, page: int = 0) -> InlineKeyboardMarkup:
        ...
        if page > 0:
            pagination_row.append(
                InlineKeyboardButton(text="◀️ Prev", callback_data=f"top_posts:page:{channel_id}:{period}:{page-1}")
            )
        
        pagination_row.append(
            InlineKeyboardButton(text="🔄 Refresh", callback_data=f"top_posts:refresh:{channel_id}:{period}")
        )
        
        pagination_row.append(
            InlineKeyboardButton(text="Next ▶️", callback_data=f"top_posts:page:{channel_id}:{period}:{page+1}")
        )
    ...
    @staticmethod
    def confirmation_keyboard(action: str, confirm_data: str, cancel_data: str) -> InlineKeyboardMarkup:
...
def get_export_format_keyboard(export_type: str) -> InlineKeyboardMarkup:
    ...
    if export_type in chart_types:
        buttons.append([InlineKeyboardButton(text="📊 PNG Chart", callback_data="export_format:png")])
