...
from src.mtproto_service.health_http import HealthCheckServer
from src.mtproto_service.metrics import MTProtoMetrics, initialize_metrics
...
def create_stats_loader(tg_client: TGClient, repos: RepositoryContainer, settings: MTProtoSettings):
    ...
    from src.mtproto_service.tasks.stats_loader import StatsLoaderTask
