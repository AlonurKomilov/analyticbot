"""
Multi-Tenant Bot Manager - Infra Implementation
Manages all user bot instances with LRU caching and background cleanup

This is the concrete implementation of IBotManager port living in the infra layer.
"""
...
class MultiTenantBotManager(IBotManager):
    """
