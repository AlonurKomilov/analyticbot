            ...
            formatted.append(
                {
                    ...
                    "monthly_budget": (
                        float(p["monthly_budget_usd"]) if p["monthly_budget_usd"] else None
                    ),
...
async def add_provider(
    ...
    try:
        ...
        provider_data = await repo.add_provider(
            ...
            monthly_budget_usd=(
                Decimal(str(request.monthly_budget)) if request.monthly_budget else None
            ),
        )
        ...
        return ProviderResponse(
            ...
            monthly_budget=(
                float(provider_data["monthly_budget_usd"])
                if provider_data["monthly_budget_usd"]
                else None
            ),
