...
class ComponentPerformanceTracker {
    ...
    trackComponentRender(componentName: string, renderTime: number, props: Record<string, any> = {}, prevProps: Record<string, any> = {}): ComponentMetrics {
...
export const RenderProfiler = ({
    ...
    children,
    onRender,
}: RenderProfilerProps): JSX.Element => {
...
export const PerformanceDevTools = ({ enabled = process.env.NODE_ENV === 'development' }: PerformanceDevToolsProps): JSX.Element | null => {
