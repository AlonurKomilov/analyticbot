...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column("chat_type", sa.String(20), nullable=False, default="group", 
                  comment="Type: group, supergroup, channel"),
        sa.Column("chat_title", sa.String(255), nullable=True),
        
        # Feature toggles
        sa.Column("clean_join_messages", sa.Boolean, nullable=False, server_default="false",
                  comment="Auto-delete join/leave service messages"),
        sa.Column("clean_leave_messages", sa.Boolean, nullable=False, server_default="false",
                  comment="Auto-delete leave service messages"),
        sa.Column("banned_words_enabled", sa.Boolean, nullable=False, server_default="false",
        ...
        sa.Column("anti_link_enabled", sa.Boolean, nullable=False, server_default="false",
                  comment="Block external links"),
        sa.Column("anti_forward_enabled", sa.Boolean, nullable=False, server_default="false",
        ...
        sa.Column("invite_tracking_enabled", sa.Boolean, nullable=False, server_default="false",
        ...
        sa.Column("slow_mode_enabled", sa.Boolean, nullable=False, server_default="false",
        ...
        # Anti-spam settings
        sa.Column("spam_action", sa.String(20), nullable=False, server_default="warn",
                  comment="Action on spam: warn, mute, kick, ban"),
        sa.Column("max_warnings", sa.Integer, nullable=False, server_default="3",
                  comment="Max warnings before action"),
        sa.Column("warning_action", sa.String(20), nullable=False, server_default="mute",
        ...
        sa.Column("flood_interval_seconds", sa.Integer, nullable=False, server_default="10",
                  comment="Time window for flood detection"),
        
        # Night mode settings
        sa.Column("night_mode_start_hour", sa.Integer, nullable=True,
                  comment="Night mode start hour (0-23)"),
        sa.Column("night_mode_end_hour", sa.Integer, nullable=True,
                  comment="Night mode end hour (0-23)"),
        sa.Column("night_mode_timezone", sa.String(50), nullable=True, server_default="'UTC'",
                  comment="Timezone for night mode"),
        
        # Allowed users/admins (JSON arrays of user IDs)
        sa.Column("whitelisted_users", JSONB, nullable=True,
                  comment="User IDs exempt from moderation"),
        sa.Column("admin_users", JSONB, nullable=True,
    ...
    op.create_table(
        ...
        sa.Column("warned_tg_id", sa.BigInteger, nullable=False,
    ...
    op.create_table(
        ...
        sa.Column("performed_by_tg_id", sa.BigInteger, nullable=True,
    ...
    op.create_table(
        ...
        sa.Column("user_id", sa.BigInteger, nullable=False, index=True),
        sa.Column("chat_id", sa.BigInteger, nullable=False),
        sa.Column("message_type", sa.String(20), nullable=False, server_default="'welcome'",
        ...
        sa.Column("buttons", JSONB, nullable=True,
                  comment="Inline keyboard buttons"),
        ...
        sa.Column("delete_after_seconds", sa.Integer, nullable=True,
        ...
        sa.UniqueConstraint("user_id", "chat_id", "message_type", 
                           name="unique_user_chat_message_type"),
    )
