"""
Centralized Mock Analytics Service

Consolidated from scattered mock analytics implementations.
"""
...
from ..protocols import AnalyticsServiceProtocol
...
class MockAnalyticsService(BaseMockService, AnalyticsServiceProtocol):
    """Centralized mock analytics service for all testing needs"""
