...
class UserAIConfigORM(Base):
    ...
    response_style: Mapped[str] = mapped_column(String(20), server_default="professional", nullable=False)
    
    # Notification preferences
    auto_insights_enabled: Mapped[bool] = mapped_column(Boolean, server_default="false", nullable=False)
    auto_insights_frequency: Mapped[str] = mapped_column(String(20), server_default="daily", nullable=False)
    ...
    updated_at: Mapped[datetime] = mapped_column(
        DateTime(timezone=True), server_default="NOW()", nullable=False, onupdate=datetime.utcnow
    )
