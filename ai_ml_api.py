...
class ContentAnalysisRequest(BaseModel):
    ...
    channel_id: Optional[int] = Field(None, description="Channel ID for context")
...
class ContentAnalysisResponse(BaseModel):
    ...
    optimal_timing: Optional[Dict[str, Any]]
...
async def get_real_time_insights(
    request: RealTimeInsightsRequest,
    services: Dict = Depends(get_ml_services)
):
    """
...
async def optimize_content_real_time(
    ...
    try:
        ...
        return {
            ...
            ) if hasattr(content_optimizer, '_generate_optimization_tips') else [],
...
async def not_found_handler(request, exc):
    return {
        ...
        "available_endpoints": [
            "/health", "/analyze/content", "/analyze/churn",
