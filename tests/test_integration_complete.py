...
class TestCompleteWorkflow:
    ...
    @pytest.mark.asyncio
    async def test_telegram_api_error_handling(self, mock_bot, mock_scheduler_repo, mock_analytics_repo):
...
class TestErrorHandlerIntegration:
    ...
    def test_telegram_error_categorization(self):
        ...
        bot_kicked_error = TelegramBadRequest(
            method="sendMessage",
            message="Bot was kicked from the group"
        )
