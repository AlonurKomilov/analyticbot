...
def upgrade() -> None:
    ...
    op.execute(
        """
    CREATE INDEX IF NOT EXISTS idx_channels_user_analytics_cover
    ...
    op.execute(
        """
    CREATE INDEX IF NOT EXISTS idx_channels_user_count
    ON channels (user_id)
    ...
    op.execute(
        """
    CREATE INDEX IF NOT EXISTS idx_scheduled_posts_trending
    ...
    op.execute(
        """
    CREATE INDEX IF NOT EXISTS idx_scheduled_posts_recent_activity
    ...
    op.execute(
        """
    CREATE INDEX IF NOT EXISTS idx_sent_posts_channel_stats
    ...
    op.execute(
        """
    CREATE INDEX IF NOT EXISTS idx_scheduled_posts_timeseries
    ...
    op.execute(
        """
    CREATE INDEX IF NOT EXISTS idx_channels_user_dashboard
    ON channels (user_id)
