...
def test_old_vs_new_logic():
    ...
    if new_using_defaults == 0:
        print(f"   ✅ SUCCESS: Eliminated all hardcoded defaults!")
    else:
...
def test_edge_cases():
    ...
    print(f"   Case 1: No API data at all")
    empty_times_by_day = {}
    all_times = []
    ...
    print(f"   Case 2: Only Monday has data")
    ...
    print(f"   Case 3: Varied data per day")
    varied_times_by_day = {
