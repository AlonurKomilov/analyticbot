...
class FaultInjector:
    ...
    def _setup_default_faults(self):
        ...
        self.add_fault("network_delay", FaultConfig(
        ...
        self.add_fault("random_error", FaultConfig(
        ...
        self.add_fault("flood_wait", FaultConfig(
        ...
        self.add_fault("rate_limit", FaultConfig(
        ...
        self.add_fault("network_error", FaultConfig(
    ...
    def add_fault(self, name: str, config: FaultConfig) -> None:
        ...
        logger.debug(f"Added fault injection: {name} ({config.fault_type.value}, "
    ...
    async def _execute_fault(self, name: str, config: FaultConfig, operation: str) -> None:
        ...
        logger.warning(f"INJECTING FAULT: {name} ({config.fault_type.value}) "
...
def inject_faults(operation_name: str = "operation", injector: Optional[FaultInjector] = None):
    """
...
class FaultInjectionContext:
    ...
    def __init__(self, operation: str = "operation", injector: Optional[FaultInjector] = None):
