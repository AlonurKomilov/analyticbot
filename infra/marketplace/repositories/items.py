...
This repository handles CRUD operations for items that are purchased once,
as opposed to subscription services.
"""
...
class MarketplaceItemRepository:
    """Repository for marketplace item operations."""
