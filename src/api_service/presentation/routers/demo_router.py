...
async def get_demo_ai_recommendations(
    channel_id: int = Query(..., description="Channel ID for demo data"),
    category: str = Query("all", description="Recommendation category (content/timing/engagement/all)")
):
    """
...
async def get_admin_stats():
    ...
    from config.demo_mode_config import demo_config
    from src.shared_kernel.domain.di_container import container, configure_services
    from src.shared_kernel.domain.protocols import AdminServiceProtocol
...
async def get_user_permissions(user_id: int):
    ...
    from config.demo_mode_config import demo_config
    from src.shared_kernel.domain.di_container import container, configure_services
    from src.shared_kernel.domain.protocols import AuthServiceProtocol
