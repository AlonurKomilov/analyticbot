...
class TestAnalyticsFusionService:
    ...
    @pytest.mark.asyncio
    async def test_get_overview_successful(self, fusion_service, mock_repositories, sample_date_range):
    ...
    @pytest.mark.asyncio
    async def test_get_overview_with_fallback_subscribers(self, fusion_service, mock_repositories, sample_date_range):
    ...
    @pytest.mark.asyncio
    async def test_get_overview_zero_posts_handling(self, fusion_service, mock_repositories, sample_date_range):
    ...
    @pytest.mark.asyncio
    async def test_get_overview_exception_handling(self, fusion_service, mock_repositories, sample_date_range):
    ...
    @pytest.mark.asyncio
    async def test_get_growth_successful(self, fusion_service, mock_repositories, sample_date_range):
    ...
    @pytest.mark.asyncio
    async def test_get_growth_with_fallback(self, fusion_service, mock_repositories, sample_date_range):
        ...
        mock_repositories['channel_daily_repo'].series_data.side_effect = [[], mock_data]
    ...
    @pytest.mark.asyncio
    async def test_get_growth_exception_handling(self, fusion_service, mock_repositories, sample_date_range):
        """Test growth exception handling"""
        # Setup mock to raise exception
        mock_repositories['channel_daily_repo'].series_data.side_effect = Exception("Series data error")
    ...
    @pytest.mark.asyncio
    async def test_get_top_posts_successful(self, fusion_service, mock_repositories, sample_date_range):
    ...
    @pytest.mark.asyncio
    async def test_get_sources_successful(self, fusion_service, mock_repositories, sample_date_range):
    ...
    @pytest.mark.asyncio
    async def test_get_trending_successful(self, fusion_service, mock_repositories, sample_date_range):
    ...
    @pytest.mark.asyncio
    async def test_get_last_updated_at_successful(self, fusion_service, mock_repositories, sample_date_range):
        ...
        mock_repositories['metrics_repo'].get_latest_metrics = AsyncMock(return_value={
            'snapshot_time': expected_date
        })
        mock_repositories['channel_daily_repo'].get_latest_metric = AsyncMock(return_value={
            'day': expected_date.date()
        })
    ...
    @pytest.mark.asyncio
    async def test_get_last_updated_at_none(self, fusion_service, mock_repositories, sample_date_range):
...
class TestAnalyticsFusionServiceIntegration:
    ...
    async def test_comprehensive_analytics_workflow(self, integration_service):
        ...
        # Test last updated
        integration_service._metrics.get_latest_metrics = AsyncMock(return_value={
            'snapshot_time': to_date
        })
        integration_service._daily.get_latest_metric = AsyncMock(return_value={
            'day': to_date.date()
        })
