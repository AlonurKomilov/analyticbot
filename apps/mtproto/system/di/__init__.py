...
from apps.mtproto.system.di.collectors import CollectorsContainer
from apps.mtproto.system.di.external import ExternalContainer
from apps.mtproto.system.di.processors import ProcessorsContainer
from apps.mtproto.system.di.storage import StorageContainer
