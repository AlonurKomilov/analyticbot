...
class RepositoryFactory:
    ...
    def _create_memory_user_repository(self) -> UserRepository:
        ...
        class FallbackUserRepository:
            async def get_user_by_id(self, user_id: str): return None
            async def get_user_by_email(self, email: str): return None
            async def create_user(self, **kwargs): return None
            async def update_user(self, user_id: str, **kwargs): return None
    ...
    def _create_memory_channel_repository(self) -> ChannelRepository:
        ...
        class FallbackChannelRepository:
            async def get_channel_by_id(self, channel_id: str): return None
            async def get_channels_by_user(self, user_id: str): return []
            async def create_channel(self, **kwargs): return None
            async def update_channel(self, channel_id: str, **kwargs): return None
    ...
    def _create_memory_analytics_repository(self) -> AnalyticsRepository:
        ...
        class FallbackAnalyticsRepository:
            async def get_analytics_data(self, **kwargs): return {}
    ...
    def _create_memory_admin_repository(self) -> AdminRepository:
        ...
        class FallbackAdminRepository:
            async def get_admin_by_id(self, admin_id: str): return None
            async def create_admin(self, **kwargs): return None
    ...
    def _create_memory_alert_subscription_repository(self) -> AlertSubscriptionRepository:
        ...
        class FallbackAlertSubscriptionRepository:
            async def create_subscription(self, subscription): return subscription
            async def get_subscription(self, subscription_id): return None
            async def get_user_subscriptions(self, chat_id): return []
            async def get_channel_subscriptions(self, channel_id): return []
            async def get_active_subscriptions(self): return []
            async def update_subscription(self, subscription): return subscription
            async def delete_subscription(self, subscription_id): return False
            async def toggle_subscription(self, subscription_id): return False
    ...
    def _create_memory_alert_sent_repository(self) -> AlertSentRepository:
        ...
        class FallbackAlertSentRepository:
            async def mark_alert_sent(self, alert_sent): return True
            async def is_alert_sent(self, chat_id, channel_id, kind, key): return False
