...
from core.utils.ratelimit import TokenBucketRateLimiter, RateLimitType
...
class TestTokenBucketRateLimiter:
    ...
    def test_acquire_rejects_when_no_tokens(self, mock_time, rate_limiter, mock_redis):
        ...
        mock_redis.eval.return_value = [0, 0, 1000.0, 60.0]  # [acquired, remaining, updated_at, retry_after]
...
class TestEnhancedDeliveryService:
    ...
    def mock_delivery_service(self):
        ...
        with patch('core.services.enhanced_delivery_service.redis') as mock_redis, \
