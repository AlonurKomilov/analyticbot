...
from core import (
    ScheduledPost, Delivery, PostStatus, DeliveryStatus,
...
def test_import_architecture():
    ...
    from core import ScheduledPost, Delivery, ScheduleService, DeliveryService
    ...
    from apps.bot.deps import BotContainer
